...
static func all_impact_times_by_direction(projectile_direction: float, to_target: Variant, target_velocity: Variant = Vector4.ZERO, projectile_acceleration: Variant = Vector4.ZERO, target_acceleration: Variant = Vector4.ZERO) -> Array[float]:
...
static func best_impact_time_by_speed_vector4(projectile_speed: float, to_target: Vector4, target_velocity: Vector4 = Vector4.ZERO, projectile_acceleration: Vector4 = Vector4.ZERO, target_acceleration: Vector4 = Vector4.ZERO) -> float:
	...
	var impact_times: Array[float] = all_impact_times_vector4(projectile_speed, to_target, target_velocity, projectile_acceleration, target_acceleration);
